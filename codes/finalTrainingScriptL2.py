...
# train
rms = RMSprop()
model.compile(loss=l2_loss, optimizer=rms, metrics=[accuracy])
...
# K.clear_session()
model.save_weights("/home/subha/RefExpCVPR2018/penseur/finalTrain/modelFinalL2.h5")
model_json = model.to_json()
with open("/home/subha/RefExpCVPR2018/penseur/finalTrain/modelFinalL2.json", "w") as json_file:
